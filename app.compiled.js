...
const SeedBoxView = () => {
  ...
  const renderSlot = index => {
    ...
    /*#__PURE__*/React.createElement("div", {
      className: `w-8 h-4 rounded-t-lg z-10 relative ${seed ? '' : 'opacity-30'}`,
      style: {
        background: seed
    ...
    /*#__PURE__*/React.createElement("div", {
      className: `w-10 h-14 rounded-b-xl flex flex-col items-center justify-center gap-0.5 border border-opacity-30 relative overflow-hidden ${seed ? `${glow ? 'ring-2 ring-green-400 animate-pulse-soft' : ''}` : 'hover:border-green-400'}`,
      style: seed ? {
    ...
    seed ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      ...
      className: "text-xs font-bold text-white relative z-10 drop-shadow"
    }, plant?.species.split(' ')[0].slice(0, 3).toUpperCase())) : /*#__PURE__*/React.createElement("span", {
      className: "text-lg text-gray-500 group-hover:text-green-400 transition-colors"
    }, "+")));
  };
  const renderGrid = () => {
    const rows = [];
...
const GardenManagerView = () => {
  ...
  }, "+ New Box")), showNewGarden && /*#__PURE__*/React.createElement("div", {
