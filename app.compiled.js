...
const LIFECYCLE_STAGES = [{
  ...
  emoji: '□',
  color: 'bg-gray-100',
  description: 'No seed in slot'
}, {
  id: 'planted',
  label: 'Planted',
  emoji: '🌱',
  color: 'bg-blue-100',
  description: 'Seed has been sown'
}, {
  id: 'germinating',
  label: 'Germinating',
  emoji: '🌾',
  color: 'bg-green-100',
  description: 'Seed is sprouting'
}, {
  id: 'seedling',
  label: 'Seedling',
  emoji: '🌿',
  color: 'bg-green-200',
  description: 'Young plant with first leaves'
}, {
  id: 'vegetative',
  label: 'Vegetative',
  emoji: '🌳',
...
const PLANT_DATABASE = {
  tomato: {
    ...
    varieties: [{
      name: 'Cherry',
      description: 'Small, sweet, prolific fruiting'
    }, {
      name: 'Beefsteak',
      description: 'Large, meaty, perfect for slicing'
    }, {
      name: 'Roma',
      description: 'Oval, great for sauces and canning'
    }],
    sowWindow: {
      start: '02-15',
      end: '05-15'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Seed rot',
          solutions: ['Improve drainage', 'Reduce watering frequency', 'Use fresh seed']
        }, {
          issue: 'Damping off',
          solutions: ['Ensure air circulation', 'Use sterile soil', 'Avoid overwatering']
        }]
      },
      germinating: {
        durationDays: {
        ...
        commonIssues: [{
          ...
          solutions: ['Increase light intensity', 'Lower temperature', 'Position light closer']
        }, {
          issue: 'Slow germination',
          solutions: ['Check soil temperature', 'Ensure proper moisture', 'Verify seed viability']
        }]
      },
      seedling: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Purple discoloration',
          solutions: ['Increase light', 'Warm up environment', 'Check phosphorus']
        }, {
          issue: 'Wilting',
          solutions: ['Reduce light intensity', 'Increase humidity', 'Check for pests']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Bolting indoors',
          solutions: ['Reduce temperature', 'Provide longer days', 'Prepare for transplant']
        }, {
          issue: 'Blossom end rot',
          solutions: ['Maintain calcium levels', 'Keep watering consistent', 'Avoid overshooting nitrate']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Flower drop',
          solutions: ['Maintain 15-25°C temperature', 'Ensure consistent moisture', 'Increase potassium']
        }, {
          issue: 'Poor pollination',
          solutions: ['Increase air movement', 'Provide bee access', 'Tap flowers gently']
        }]
      },
      fruiting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Blossom end rot',
          solutions: ['Maintain consistent moisture', 'Add calcium supplement', 'Mulch to regulate soil']
        }, {
          issue: 'Fruit cracking',
          solutions: ['Water evenly', 'Provide shade cloth', 'Maintain soil moisture']
        }]
      },
      harvesting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Green shoulder',
          solutions: ['Reduce nitrogen', 'Ensure adequate phosphorus', 'Increase potassium']
        }, {
          issue: 'Slow ripening',
          solutions: ['Increase temperature', 'Reduce nitrogen', 'Ensure sun exposure']
        }]
      },
      done: {
        durationDays: {
  ...
  pepper: {
    ...
    varieties: [{
      name: 'Bell',
      description: 'Large sweet peppers, multiple colors'
    }, {
      name: 'Chili',
      description: 'Hot peppers with varying heat levels'
    }],
    sowWindow: {
      start: '02-01',
      end: '04-30'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Very slow germination',
          solutions: ['Increase soil temperature', 'Scarify seed coat', 'Use seed starting hormone']
        }, {
          issue: 'Mold growth',
          solutions: ['Improve air circulation', 'Reduce humidity', 'Use fungicide if needed']
        }]
      },
      germinating: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Damping off',
          solutions: ['Reduce moisture', 'Increase air flow', 'Sterilize soil']
        }, {
          issue: 'Slow growth',
          solutions: ['Ensure adequate light', 'Maintain warmth', 'Check humidity']
        }]
      },
      seedling: {
        durationDays: {
        ...
        commonIssues: [{
          ...
          solutions: ['Increase light hours', 'Warm environment', 'Check nutrients']
        }, {
          issue: 'Spider mites',
          solutions: ['Increase humidity', 'Spray with neem oil', 'Improve air movement']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Sudden wilting',
          solutions: ['Check for root rot', 'Adjust watering', 'Monitor temperature']
        }, {
          issue: 'Yellowing leaves',
          solutions: ['Check nitrogen levels', 'Ensure drainage', 'Test pH']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Flower drop',
          solutions: ['Maintain stable temperature', 'Reduce sudden stress', 'Increase phosphorus']
        }, {
          issue: 'Poor pollination',
          solutions: ['Provide good air movement', 'Tap flowers', 'Reduce nitrogen']
        }]
      },
      fruiting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Fruit drop',
          solutions: ['Maintain temperature stability', 'Ensure consistent watering', 'Check humidity']
        }, {
          issue: 'Sunscald',
          solutions: ['Provide afternoon shade', 'Maintain soil moisture', 'Avoid defoliation']
        }]
      },
      harvesting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Slow ripening',
          solutions: ['Ensure adequate light', 'Maintain warmth', 'Reduce nitrogen']
        }, {
          issue: 'Rotting on vine',
          solutions: ['Improve air circulation', 'Avoid overhead watering', 'Remove affected fruit']
        }]
      },
      done: {
        durationDays: {
  ...
  lettuce: {
    ...
    varieties: [{
      name: 'Butterhead',
      description: 'Soft, tender, creamy center'
    }, {
      name: 'Romaine',
      description: 'Crisp, upright, great for Caesar salads'
    }],
    sowWindow: {
      start: '02-01',
      end: '10-31'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Seed drying out',
          solutions: ['Water frequently', 'Use mulch', 'Increase humidity']
        }, {
          issue: 'Fungal disease',
          solutions: ['Improve drainage', 'Reduce humidity', 'Provide air flow']
        }]
      },
      germinating: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Damping off',
          solutions: ['Reduce excess moisture', 'Increase air circulation', 'Ensure good drainage']
        }, {
          issue: 'Heat stress',
          solutions: ['Provide shade cloth', 'Increase watering', 'Mulch around plants']
        }]
      },
      seedling: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Leggy growth',
          solutions: ['Increase light', 'Reduce temperature', 'Avoid overcrowding']
        }, {
          issue: 'Wilting in heat',
          solutions: ['Provide afternoon shade', 'Increase watering', 'Mulch soil']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Bolting (flowering)',
          solutions: ['Provide shade in heat', 'Maintain consistent moisture', 'Plant heat-tolerant varieties']
        }, {
          issue: 'Bitter taste',
          solutions: ['Keep plants cool', 'Increase shade', 'Harvest before flowering']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Early bolting',
          solutions: ['Plant in cool season', 'Provide shade', 'Choose bolt-resistant varieties']
        }]
      },
      fruiting: {
        durationDays: {
      ...
      harvesting: {
        ...
        commonIssues: [{
          issue: 'Tough, bitter leaves',
          solutions: ['Harvest earlier', 'Maintain cooler temps', 'Increase watering']
        }]
      },
      done: {
        durationDays: {
  ...
  cucumber: {
    ...
    varieties: [{
      name: 'Slicing',
      description: 'Long, smooth, perfect for fresh eating'
    }, {
      name: 'Pickling',
      description: 'Shorter, bumpy, ideal for pickles'
    }],
    sowWindow: {
      start: '04-15',
      end: '07-15'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Seed rot',
          solutions: ['Ensure good drainage', 'Avoid overwatering', 'Use fresh seed']
        }, {
          issue: 'Slow germination',
          solutions: ['Increase soil temperature', 'Plant later in season', 'Check seed viability']
        }]
      },
      germinating: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Damping off',
          solutions: ['Improve drainage', 'Increase air circulation', 'Avoid overwatering']
        }]
      },
      seedling: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Leggy growth',
          solutions: ['Increase sunlight', 'Reduce temperature', 'Improve air flow']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          ...
          solutions: ['Improve air circulation', 'Water at soil level', 'Spray with sulfur']
        }, {
          issue: 'Yellowing leaves',
          solutions: ['Check nitrogen levels', 'Ensure adequate water', 'Treat for pests']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Flower drop',
          solutions: ['Maintain 20-28°C', 'Increase potassium', 'Ensure consistent moisture']
        }, {
          issue: 'Poor pollination',
          solutions: ['Encourage pollinators', 'Hand pollinate if needed', 'Avoid pesticides']
        }]
      },
      fruiting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Curved cucumbers',
          solutions: ['Maintain consistent watering', 'Support fruit horizontally', 'Ensure good light']
        }, {
          issue: 'Bitter cucumbers',
          solutions: ['Water more frequently', 'Maintain 22-28°C', 'Avoid stress']
        }]
      },
      harvesting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Overripe, yellow cucumbers',
          solutions: ['Harvest more frequently', 'Check plant regularly', 'Remove oversized fruit']
        }, {
          issue: 'Cucumber beetles',
          solutions: ['Use row covers initially', 'Hand pick', 'Apply organic pesticide']
        }]
      },
      done: {
        durationDays: {
  ...
  zucchini: {
    ...
    varieties: [{
      name: 'Green',
      description: 'Dark green, prolific summer squash'
    }, {
      name: 'Yellow',
      description: 'Golden color, slightly sweeter'
    }],
    sowWindow: {
      start: '04-01',
      end: '06-30'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Seed rot',
          solutions: ['Improve drainage', 'Use warm soil', 'Reduce watering']
        }]
      },
      germinating: {
        durationDays: {
      ...
      vegetative: {
        ...
        commonIssues: [{
          issue: 'Powdery mildew',
          solutions: ['Improve air circulation', 'Water at soil level', 'Spray with fungicide']
        }, {
          issue: 'Vine borers',
          solutions: ['Wrap stems with barriers', 'Inject BT into stems', 'Remove damaged vines']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Flower drop',
          solutions: ['Maintain consistent watering', 'Avoid temperature extremes', 'Ensure good pollination']
        }]
      },
      fruiting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Misshapen fruits',
          solutions: ['Ensure consistent watering', 'Avoid excessive nitrogen', 'Provide good pollination']
        }, {
          issue: 'Blossom end rot',
          solutions: ['Maintain consistent moisture', 'Add calcium', 'Mulch soil']
        }]
      },
      harvesting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Oversized, bitter zucchini',
          solutions: ['Harvest more frequently', 'Check plants daily', 'Remove oversized fruits']
        }, {
          issue: 'Powdery mildew on fruits',
          solutions: ['Improve air circulation', 'Remove infected leaves', 'Apply sulfur spray']
        }]
      },
      done: {
        durationDays: {
  ...
  basil: {
    ...
    varieties: [{
      name: 'Sweet',
      description: 'Classic Italian basil, aromatic'
    }, {
      name: 'Thai',
      description: 'Spicy, peppery, essential for Asian cuisine'
    }],
    sowWindow: {
      start: '04-15',
      end: '06-30'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Slow germination',
          solutions: ['Increase temperature', 'Ensure moisture', 'Use fresh seed']
        }]
      },
      germinating: {
        durationDays: {
      ...
      seedling: {
        ...
        commonIssues: [{
          issue: 'Leggy seedlings',
          solutions: ['Increase light', 'Reduce temperature', 'Improve air flow']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Leggy, sparse growth',
          solutions: ['Pinch tops regularly', 'Provide more light', 'Increase temperatures']
        }, {
          issue: 'Fungal disease',
          solutions: ['Improve air flow', 'Avoid wetting leaves', 'Reduce humidity']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Plant bolting early',
          solutions: ['Pinch buds regularly', 'Maintain consistent moisture', 'Avoid stress']
        }]
      },
      fruiting: {
        durationDays: {
      ...
      harvesting: {
        ...
        commonIssues: [{
          issue: 'Plant becomes woody',
          solutions: ['Harvest more frequently', 'Pinch tops regularly', 'Start new plants seasonally']
        }]
      },
      done: {
        durationDays: {
  ...
  carrot: {
    ...
    varieties: [{
      name: 'Nantes',
      description: 'Medium-long, sweet, tender core'
    }, {
      name: 'Chantenay',
      description: 'Shorter, stout, excellent flavor'
    }],
    sowWindow: {
      start: '02-15',
      end: '08-31'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          ...
          solutions: ['Keep soil moist throughout germination', 'Soak seeds 2-4 hours', 'Ensure adequate light']
        }, {
          issue: 'Soil crusting',
          solutions: ['Water gently', 'Thin seedlings carefully', 'Use sand mulch']
        }]
      },
      germinating: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Slow germination',
          solutions: ['Ensure moist soil', 'Provide light', 'Keep temperature moderate']
        }]
      },
      seedling: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Crowding causing forked roots',
          solutions: ['Thin aggressively early', 'Remove weak seedlings', 'Maintain 5cm spacing']
        }, {
          issue: 'Green shoulders on developing roots',
          solutions: ['Increase soil depth', 'Hill up soil around roots', 'Provide shade']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Carrot rust fly damage',
          solutions: ['Use row covers', 'Intercrop with onions', 'Remove damaged plants early']
        }, {
          issue: 'Yellowing foliage',
          solutions: ['Check drainage', 'Ensure nitrogen levels', 'Check for pests']
        }]
      },
      flowering: {
        durationDays: {
      ...
      harvesting: {
        ...
        commonIssues: [{
          issue: 'Splitting and cracking',
          solutions: ['Maintain consistent moisture', 'Avoid overwatering after dry period', 'Mulch to regulate soil']
        }, {
          issue: 'Tough, woody texture',
          solutions: ['Harvest earlier', 'Maintain consistent watering', 'Improve soil texture']
        }]
      },
      done: {
        durationDays: {
  ...
  bean: {
    ...
    varieties: [{
      name: 'Bush',
      description: 'Compact, determinate, no staking needed'
    }, {
      name: 'Pole',
      description: 'Vining, requires support, extended harvest'
    }],
    sowWindow: {
      start: '04-15',
      end: '07-15'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Seed rot',
          solutions: ['Improve drainage', 'Ensure warmth', 'Use fresh seed']
        }]
      },
      germinating: {
        durationDays: {
      ...
      vegetative: {
        ...
        commonIssues: [{
          issue: 'Leaf beetles',
          solutions: ['Hand pick', 'Use row covers', 'Spray with neem']
        }, {
          issue: 'Powdery mildew',
          solutions: ['Improve air circulation', 'Water at soil level', 'Use sulfur spray']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Flower drop',
          solutions: ['Maintain consistent moisture', 'Avoid temperature extremes', 'Reduce nitrogen']
        }]
      },
      fruiting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Pod drop',
          solutions: ['Maintain consistent watering', 'Avoid temperature stress', 'Continue fertilizing']
        }]
      },
      harvesting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Tough, stringy beans',
          solutions: ['Harvest more frequently', 'Pick when smaller', 'Check variety for strings']
        }]
      },
      done: {
        durationDays: {
  ...
  pea: {
    ...
    varieties: [{
      name: 'Sugar Snap',
      description: 'Eat whole pod, sweet and crunchy'
    }, {
      name: 'Garden',
      description: 'Shell peas, classic sweet flavor'
    }],
    sowWindow: {
      start: '02-01',
      end: '04-30'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Seed rot in wet soil',
          solutions: ['Improve drainage', 'Wait for proper soil conditions', 'Use treated seed']
        }]
      },
      germinating: {
        durationDays: {
      ...
      seedling: {
        ...
        commonIssues: [{
          issue: 'Stretching for support',
          solutions: ['Provide early support', 'Increase light', 'Thin seedlings']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Powdery mildew',
          solutions: ['Improve air flow', 'Water at soil level', 'Use sulfur spray']
        }, {
          issue: 'Pea moth damage',
          solutions: ['Use pheromone traps', 'Plant earlier or later', 'Remove affected pods']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Flower drop in heat',
          solutions: ['Provide shade cloth in heat', 'Maintain consistent watering', 'Plant earlier crop']
        }]
      },
      fruiting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Empty or poorly filled pods',
          solutions: ['Ensure adequate watering', 'Check pollination', 'Maintain consistent moisture']
        }]
      },
      harvesting: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Tough, starchy peas',
          solutions: ['Harvest earlier', 'Use sugar snap variety', 'Refrigerate quickly after picking']
        }]
      },
      done: {
        durationDays: {
  ...
  spinach: {
    ...
    varieties: [{
      name: 'Bloomsdale',
      description: 'Crinkled leaves, very hardy, excellent flavor'
    }, {
      name: 'Baby Leaf',
      description: 'Small tender leaves, quick growing'
    }],
    sowWindow: {
      start: '02-15',
      end: '04-30'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Poor germination in heat',
          solutions: ['Plant in spring or fall only', 'Provide afternoon shade', 'Soak seeds']
        }]
      },
      germinating: {
        durationDays: {
      ...
      seedling: {
        ...
        commonIssues: [{
          issue: 'Bolting (flowering) in heat',
          solutions: ['Plant cool season only', 'Provide shade in spring', 'Plant heat-resistant varieties']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Bolting (going to flower)',
          solutions: ['Provide shade cloth', 'Increase watering frequency', 'Harvest before flowering']
        }, {
          issue: 'Leaf spot disease',
          solutions: ['Improve air circulation', 'Water at soil level', 'Remove infected leaves']
        }]
      },
      flowering: {
        durationDays: {
  ...
  kale: {
    ...
    varieties: [{
      name: 'Curly',
      description: 'Highly frilly leaves, very tender when young'
    }, {
      name: 'Lacinato',
      description: 'Smooth blue-green leaves, deeply textured'
    }],
    sowWindow: {
      start: '03-01',
      end: '08-31'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Poor germination',
          solutions: ['Ensure consistent moisture', 'Maintain proper temperature', 'Use fresh seed']
        }]
      },
      germinating: {
        durationDays: {
      ...
      seedling: {
        ...
        commonIssues: [{
          issue: 'Damping off',
          solutions: ['Improve air circulation', 'Reduce humidity', 'Ensure good drainage']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Cabbage worms',
          solutions: ['Use row covers', 'Hand pick caterpillars', 'Spray with BT']
        }, {
          issue: 'Black rot disease',
          solutions: ['Improve drainage', 'Remove infected leaves', 'Rotate crops']
        }]
      },
      flowering: {
        durationDays: {
      ...
      harvesting: {
        ...
        commonIssues: [{
          issue: 'Tough, bitter leaves',
          solutions: ['Harvest when younger', 'Expose to light frost for sweetness', 'Maintain consistent watering']
        }]
      },
      done: {
        durationDays: {
  ...
  onion: {
    ...
    varieties: [{
      name: 'Yellow',
      description: 'Storage type, pungent, long keeping'
    }, {
      name: 'Red',
      description: 'Sweet, purple-red, excellent raw'
    }],
    sowWindow: {
      start: '02-15',
      end: '04-30'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Slow germination',
          solutions: ['Ensure moisture', 'Increase light', 'Maintain proper temperature']
        }]
      },
      germinating: {
        durationDays: {
      ...
      seedling: {
        ...
        commonIssues: [{
          issue: 'Leggy, weak seedlings',
          solutions: ['Increase light intensity', 'Reduce temperature', 'Improve air circulation']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Onion maggots',
          solutions: ['Use row covers', 'Maintain soil moisture', 'Remove affected plants early']
        }, {
          issue: 'Purple blotch disease',
          solutions: ['Improve air circulation', 'Water at soil level', 'Rotate crops']
        }]
      },
      flowering: {
        durationDays: {
      ...
      harvesting: {
        ...
        commonIssues: [{
          issue: 'Thick necks (won\'t keep)',
          solutions: ['Reduce nitrogen after bulbing starts', 'Harvest when ready', 'Improve storage conditions']
        }, {
          issue: 'Small bulbs',
          solutions: ['Ensure proper spacing', 'Maintain consistent moisture', 'Provide full sun']
        }]
      },
      done: {
        durationDays: {
  ...
  radish: {
    ...
    varieties: [{
      name: 'Cherry Belle',
      description: 'Small, round, quick growing (25 days)'
    }, {
      name: 'Daikon',
      description: 'Large, mild, storage type'
    }],
    sowWindow: {
      start: '02-15',
      end: '09-30'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Poor germination',
          solutions: ['Ensure moisture', 'Maintain cool temperature', 'Use fresh seed']
        }]
      },
      germinating: {
        durationDays: {
      ...
      seedling: {
        ...
        commonIssues: [{
          issue: 'Forked or malformed radishes',
          solutions: ['Thin earlier and more aggressively', 'Remove crowded seedlings', 'Maintain consistent moisture']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Radish root maggots',
          solutions: ['Use row covers', 'Remove affected plants', 'Crop rotation']
        }, {
          issue: 'Powdery mildew on leaves',
          solutions: ['Improve air circulation', 'Water at soil level', 'Use sulfur if needed']
        }]
      },
      flowering: {
        durationDays: {
      ...
      harvesting: {
        ...
        commonIssues: [{
          issue: 'Hollow, pithy radishes',
          solutions: ['Harvest earlier', 'Provide consistent moisture', 'Avoid temperature stress']
        }, {
          issue: 'Tough, hot flavor',
          solutions: ['Harvest when smaller', 'Maintain consistent watering', 'Grow in cooler season']
        }]
      },
      done: {
        durationDays: {
  ...
  broccoli: {
    ...
    varieties: [{
      name: 'Calabrese',
      description: 'Large main heads, classic variety'
    }, {
      name: 'Sprouting',
      description: 'Many small side shoots, extended harvest'
    }],
    sowWindow: {
      start: '03-01',
      end: '08-31'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Poor germination',
          solutions: ['Ensure moisture', 'Maintain proper temperature', 'Use fresh seed']
        }]
      },
      germinating: {
        durationDays: {
      ...
      seedling: {
        ...
        commonIssues: [{
          issue: 'Damping off',
          solutions: ['Improve air circulation', 'Reduce humidity', 'Use sterile soil']
        }, {
          issue: 'Leggy seedlings',
          solutions: ['Increase light', 'Lower temperature', 'Improve air flow']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Cabbage worms',
          solutions: ['Use row covers initially', 'Hand pick caterpillars', 'Spray with BT']
        }, {
          issue: 'Black rot',
          solutions: ['Improve drainage', 'Remove infected leaves', 'Crop rotation']
        }]
      },
      flowering: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Small, loose heads',
          solutions: ['Ensure adequate watering', 'Provide full sun', 'Maintain cool temperatures']
        }, {
          issue: 'Yellow florets',
          solutions: ['Harvest earlier', 'Maintain cooler temps', 'Improve drainage']
        }]
      },
      fruiting: {
        durationDays: {
      ...
      harvesting: {
        ...
        commonIssues: [{
          issue: 'Premature bolting/flowering',
          solutions: ['Provide afternoon shade in heat', 'Maintain consistent water', 'Harvest main head promptly']
        }, {
          issue: 'Loose, open florets',
          solutions: ['Harvest earlier', 'Avoid heat stress', 'Ensure adequate water']
        }]
      },
      done: {
        durationDays: {
  ...
  parsley: {
    ...
    varieties: [{
      name: 'Flat Leaf',
      description: 'Italian parsley, strong flavor, fast growing'
    }, {
      name: 'Curly',
      description: 'Decorative, milder flavor, traditional'
    }],
    sowWindow: {
      start: '02-15',
      end: '07-31'
    ...
    lifecycle: {
      planted: {
        ...
        commonIssues: [{
          issue: 'Very slow germination',
          solutions: ['Soak seeds longer', 'Ensure consistent moisture', 'Increase temperature slightly to 20°C', 'Use fresh seed']
        }]
      },
      germinating: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Damping off during long germination',
          solutions: ['Improve air circulation', 'Reduce humidity slightly', 'Use sterile soil']
        }]
      },
      seedling: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Slow growth',
          solutions: ['Ensure adequate light', 'Maintain moisture', 'Be patient with parsley']
        }]
      },
      vegetative: {
        durationDays: {
        ...
        commonIssues: [{
          issue: 'Leaf miners',
          solutions: ['Remove affected leaves', 'Use insecticides if severe', 'Maintain plant health']
        }, {
          issue: 'Yellowing leaves',
          solutions: ['Check drainage', 'Ensure proper spacing', 'Remove lower yellowed leaves']
        }]
      },
      flowering: {
        durationDays: {
      ...
      harvesting: {
        ...
        commonIssues: [{
          issue: 'Plant becoming leggy or sparse',
          solutions: ['Harvest more regularly', 'Pinch stems more frequently', 'Provide better light']
        }]
      },
      done: {
        durationDays: {
...
const DataProvider = ({
  ...
  const updateGarden = useCallback((gardenId, updates) => {
    setGardens(prev => prev.map(g => g.id === gardenId ? {
      ...g,
      ...updates
    } : g));
  }, []);
  ...
  useEffect(() => {
    ...
    seeds.forEach(seed => {
      if (seed.expiryDate) {
        ...
        if (daysUntilExpiry > 0 && daysUntilExpiry <= 30) {
          addNotification('warning', `${seed.species} expiring soon`, `Seed expires in ${daysUntilExpiry} days`);
        }
      }
    });
    ...
    tasks.forEach(task => {
      if (!task.completed && task.dueDate) {
        ...
        if (dueDate === today) {
          addNotification('info', 'Task due today', task.description);
        }
      }
    });
  }, [seeds, tasks]);
...
const SeedBoxView = () => {
  ...
  const renderSlot = index => {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: `
          ...
          ${seed ? `text-white font-bold text-xs text-center px-1 ${glow ? 'ring-2 ring-green-400 animate-pulse' : ''}` : 'border-2 border-dashed border-gray-300 text-gray-400 hover:border-green-400'}
          ${seed ? 'shadow-md hover:shadow-lg' : 'hover:bg-gray-50'}
        `,
      style: seed ? {
        backgroundColor: color
      } : {}
    }, seed ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "text-sm"
    }, plant?.emoji), /*#__PURE__*/React.createElement("span", {
      className: "text-xs font-semibold"
    }, plant?.species.split(' ')[0].slice(0, 3).toUpperCase())) : /*#__PURE__*/React.createElement("span", {
      className: "text-lg"
    }, "+"));
  };
  const renderGrid = () => {
  ...
  }, slotsUsed, "/40"), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600 mt-1"
  }, "Slots Used")), /*#__PURE__*/React.createElement("div", {
    className: "bg-orange-50 rounded-lg p-4 text-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-2xl font-bold text-orange-600"
  }, expiringCount), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600 mt-1"
  }, "Expiring Soon")), /*#__PURE__*/React.createElement("div", {
    className: "bg-green-50 rounded-lg p-4 text-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-2xl font-bold text-green-600"
  }, inSowWindow), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600 mt-1"
  }, "In Sow Window"))), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setSelectedFamily(null),
    className: `px-3 py-1 rounded-full text-sm font-medium transition-all ${selectedFamily === null ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`
  }, "All"), Object.keys(PLANT_FAMILIES).map(family => /*#__PURE__*/React.createElement("button", {
    key: family,
    onClick: () => setSelectedFamily(family),
    className: `px-3 py-1 rounded-full text-sm font-medium transition-all ${selectedFamily === family ? 'text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`,
    style: selectedFamily === family ? {
      backgroundColor: PLANT_FAMILIES[family]
    } : {}
  }, family))), /*#__PURE__*/React.createElement("div", {
    className: "bg-white rounded-xl border-2 border-green-200 p-8 space-y-6"
  }, renderGrid()), selectedSlot !== null && /*#__PURE__*/React.createElement(SeedSlotModal, {
...
const SeedSlotModal = ({
  ...
  if (seed && !isEditing) {
    ...
    }, selectedPlant?.emoji), /*#__PURE__*/React.createElement("h3", {
      className: "text-2xl font-bold text-gray-900"
    }, selectedPlant?.commonName), /*#__PURE__*/React.createElement("p", {
      className: "text-sm text-gray-600 italic"
    }, selectedPlant?.species)), /*#__PURE__*/React.createElement("span", {
      className: "px-3 py-1 bg-white rounded-full text-sm font-medium text-gray-700"
    }, selectedPlant?.family))), /*#__PURE__*/React.createElement("div", {
      className: "grid grid-cols-2 gap-4"
    }, /*#__PURE__*/React.createElement("div", {
      className: "bg-gray-50 rounded-lg p-3"
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-600 mb-1"
    }, "Variety"), /*#__PURE__*/React.createElement("div", {
      className: "font-semibold text-gray-900"
    }, formData.variety || 'N/A')), /*#__PURE__*/React.createElement("div", {
      className: "bg-gray-50 rounded-lg p-3"
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-600 mb-1"
    }, "Quantity"), /*#__PURE__*/React.createElement("div", {
      className: "font-semibold text-gray-900"
    }, formData.quantity)), /*#__PURE__*/React.createElement("div", {
      className: "bg-gray-50 rounded-lg p-3"
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-600 mb-1"
    }, "Sow Window"), /*#__PURE__*/React.createElement("div", {
      className: "font-semibold text-gray-900"
    }, formData.sowWindowStart, " to ", formData.sowWindowEnd)), /*#__PURE__*/React.createElement("div", {
      className: `rounded-lg p-3 ${isInSowWindow(selectedPlant) ? 'bg-green-100' : 'bg-gray-100'}`
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-600 mb-1"
    }, "Status"), /*#__PURE__*/React.createElement("div", {
      className: `font-semibold ${isInSowWindow(selectedPlant) ? 'text-green-700' : 'text-gray-600'}`
    }, isInSowWindow(selectedPlant) ? '✓ In Season' : 'Off Season'))), formData.expiryDate && /*#__PURE__*/React.createElement("div", {
      className: `rounded-lg p-3 ${daysBetween(new Date(), new Date(formData.expiryDate)) <= 30 ? 'bg-red-100' : 'bg-gray-50'}`
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-600 mb-1"
    }, "Expires"), /*#__PURE__*/React.createElement("div", {
      className: `font-semibold ${daysBetween(new Date(), new Date(formData.expiryDate)) <= 30 ? 'text-red-700' : 'text-gray-700'}`
    }, formatDate(formData.expiryDate), " (", daysBetween(new Date(), new Date(formData.expiryDate)), " days)")), formData.notes && /*#__PURE__*/React.createElement("div", {
      className: "bg-blue-50 rounded-lg p-3"
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-600 mb-1"
    }, "Notes"), /*#__PURE__*/React.createElement("div", {
      className: "text-sm text-gray-700"
    }, formData.notes)), /*#__PURE__*/React.createElement("div", {
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    isOpen: isOpen,
    onClose: onClose,
    title: seed ? 'Edit Seed' : 'Add Seed',
    size: "md"
  }, /*#__PURE__*/React.createElement("div", {
    className: "space-y-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-semibold text-gray-700 mb-2"
  }, "Plant Species"), /*#__PURE__*/React.createElement("select", {
    value: formData.plantId,
    onChange: e => handlePlantChange(e.target.value),
    className: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
  }, /*#__PURE__*/React.createElement("option", {
    value: ""
  }, "Select a plant..."), Object.values(PLANT_DATABASE).map(plant => /*#__PURE__*/React.createElement("option", {
    key: plant.id,
    value: plant.id
  }, plant.emoji, " ", plant.commonName, " (", plant.species, ")")))), selectedPlant && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-semibold text-gray-700 mb-2"
  }, "Variety"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    ...
    id: "varieties"
  }, selectedPlant.varieties.map((v, i) => /*#__PURE__*/React.createElement("option", {
    key: i,
    value: v.name
  })))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-semibold text-gray-700 mb-2"
    ...
    className: "block text-sm font-semibold text-gray-700 mb-2"
  }, "Sow Start"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: formData.sowWindowStart,
    onChange: e => setFormData(prev => ({
      ...prev,
      sowWindowStart: e.target.value
    })),
    placeholder: "MM-DD",
    className: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-semibold text-gray-700 mb-2"
  }, "Sow End"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: formData.sowWindowEnd,
    onChange: e => setFormData(prev => ({
      ...prev,
      sowWindowEnd: e.target.value
    })),
    placeholder: "MM-DD",
    className: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
  }))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
...
const PlantTimeline = ({
  ...
  }, "Lifecycle Timeline"), /*#__PURE__*/React.createElement("div", {
  ...
  })), tooltipStage !== null && /*#__PURE__*/React.createElement("div", {
    className: "absolute bg-gray-900 text-white px-3 py-2 rounded-lg text-xs shadow-lg z-10 -translate-x-1/2",
    style: {
  ...
  }, LIFECYCLE_STAGES[tooltipStage]?.label), plantInfo?.lifecycle?.[LIFECYCLE_STAGES[tooltipStage]?.id]?.careTips?.[0] && /*#__PURE__*/React.createElement("div", {
    className: "mt-1 text-gray-200"
  }, plantInfo.lifecycle[LIFECYCLE_STAGES[tooltipStage].id].careTips[0]), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-full border-4 border-transparent border-t-gray-900"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "mt-6 space-y-2 px-4"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "font-semibold text-gray-700"
  }, "Key Dates"), plant.milestones && plant.milestones.slice(0, 3).map((milestone, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    className: "flex justify-between text-sm text-gray-600"
  }, /*#__PURE__*/React.createElement("span", null, milestone.stage), /*#__PURE__*/React.createElement("span", {
    className: "text-gray-400"
  }, milestone.actualDate ? formatDate(milestone.actualDate) : `Expected: ${formatDate(milestone.expectedDate)}`)))), /*#__PURE__*/React.createElement("style", null, `
        @keyframes pulse {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.7; }
        }
...
const HealthIndicator = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `${config.color} ${config.textColor} px-4 py-3 rounded-lg font-semibold text-center`
  }, config.label), status !== 'healthy' && /*#__PURE__*/React.createElement("div", {
    className: "bg-red-50 border-l-4 border-red-400 p-4 rounded"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "font-semibold text-red-800 mb-2"
  }, "\u26A0\uFE0F Common Issues"), /*#__PURE__*/React.createElement("ul", {
    className: "text-sm text-red-700 space-y-1"
  }, stageData?.commonIssues?.slice(0, 2).map((issue, idx) => /*#__PURE__*/React.createElement("li", {
    key: idx,
    className: "flex items-start gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-red-400 mt-0.5"
  }, "\u2022"), /*#__PURE__*/React.createElement("span", null, issue.issue, ": ", issue.solutions?.[0]))))), indicators.length > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
    className: "font-semibold text-gray-700 mb-2"
  }, "Stage Indicators"), /*#__PURE__*/React.createElement("ul", {
    className: "space-y-1 text-sm text-gray-600"
  }, indicators.map((indicator, idx) => /*#__PURE__*/React.createElement("li", {
    key: idx,
...
const GardenSquare = ({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    className: "flex-1 flex flex-col items-center justify-center p-2 gap-1"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-3xl"
  }, plantInfo?.emoji || '🌱'), /*#__PURE__*/React.createElement("span", {
    className: "text-xs font-semibold text-gray-800 text-center line-clamp-2"
  }, plantInfo?.commonName), /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-gray-500"
  }, square.currentStage)), /*#__PURE__*/React.createElement("div", {
    className: "absolute top-2 right-2"
  }, /*#__PURE__*/React.createElement("div", {
    className: `w-3 h-3 rounded-full ${healthColors[square.health || 'healthy']}`
  })), /*#__PURE__*/React.createElement("div", {
...
const GardenBox = ({
  ...
  }, garden.name), /*#__PURE__*/React.createElement("button", {
  ...
  }, garden.squares.map((square, idx) => /*#__PURE__*/React.createElement(GardenSquare, {
    key: idx,
    square: square,
    gardenId: garden.id,
...
const PlantDetailModal = ({
  ...
  const handleAdvanceStage = async () => {
    ...
    const updatedSquare = {
      ...
      milestones: square.milestones?.map(m => m.stage === nextStage ? {
        ...m,
  ...
  const filteredPlants = Object.values(PLANT_DATABASE).filter(p => (p.commonName || '').toLowerCase().includes(searchTerm.toLowerCase()) || p.varieties?.some(v => (v.name || v).toLowerCase().includes(searchTerm.toLowerCase())));
  return /*#__PURE__*/React.createElement(Modal, {
    isOpen: isOpen,
    onClose: onClose
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full max-w-2xl max-h-[90vh] overflow-y-auto"
  }, isEmpty ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold text-gray-800 mb-4"
  }, "Plant a Seed"), /*#__PURE__*/React.createElement("div", {
    className: "mb-4"
  ...
  }, filteredPlants.map(plant => /*#__PURE__*/React.createElement("button", {
    key: plant.id,
    ...
    className: "text-2xl"
  }, plant.emoji), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "font-semibold text-gray-800"
  }, plant.commonName), /*#__PURE__*/React.createElement("div", {
    className: "text-sm text-gray-600"
  }, plant.varieties?.map(v => v.name).join(', ') || 'Classic')))))), selectedPlant && /*#__PURE__*/React.createElement("div", {
    className: "bg-green-50 p-4 rounded-lg mb-4 border border-green-200"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-semibold text-green-900 mb-2"
  }, "Planting ", selectedPlant.commonName), /*#__PURE__*/React.createElement("textarea", {
  ...
  }, "Plant Now")))) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "mb-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3 mb-4"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-5xl"
  }, plantInfo?.emoji), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold text-gray-800"
  }, plantInfo?.commonName), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2 mt-1"
  }, /*#__PURE__*/React.createElement("span", {
    className: "px-2 py-1 bg-green-100 text-green-800 text-xs font-semibold rounded"
  }, square.currentStage), /*#__PURE__*/React.createElement("span", {
    className: "px-2 py-1 text-white text-xs font-semibold rounded",
    style: {
      backgroundColor: PLANT_FAMILIES[plantInfo?.family]
    }
  }, plantInfo?.family)))), square.notes && /*#__PURE__*/React.createElement("p", {
    className: "text-gray-600 text-sm bg-gray-50 p-3 rounded-lg mb-4"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-semibold"
  }, "Notes:"), " ", square.notes)), /*#__PURE__*/React.createElement(PlantTimeline, {
    plant: square,
    plantInfo: plantInfo
  }), /*#__PURE__*/React.createElement("div", {
    className: "mt-6"
  ...
  }, "\uD83C\uDF31 Care Tips"), /*#__PURE__*/React.createElement("ul", {
    className: "text-blue-800 text-sm space-y-1"
  }, (plantInfo?.lifecycle?.[square.currentStage]?.careTips || ['Keep the soil consistently moist.']).map((tip, idx) => /*#__PURE__*/React.createElement("li", {
    key: idx,
    className: "flex gap-2"
  }, /*#__PURE__*/React.createElement("span", null, "\u2022"), /*#__PURE__*/React.createElement("span", null, tip))))), plantInfo?.lifecycle?.[square.currentStage]?.commonIssues?.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "mt-6 bg-red-50 p-4 rounded-lg border border-red-200"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-semibold text-red-900 mb-2"
  }, "\u26A0\uFE0F Common Issues"), /*#__PURE__*/React.createElement("ul", {
    className: "text-sm text-red-800 space-y-2"
  }, plantInfo.lifecycle[square.currentStage].commonIssues.map((issue, idx) => /*#__PURE__*/React.createElement("li", {
    key: idx
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-semibold"
  }, issue.issue, ":"), " ", issue.solutions?.[0])))), /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u2713 Advance to Next Stage"), /*#__PURE__*/React.createElement("select", {
    onChange: e => {
      if (e.target.value === 'healthy') {
        const updated = {
          ...garden,
          squares: garden.squares.map((sq, idx) => idx === squareIndex ? {
            ...sq,
            health: 'healthy'
          } : sq)
        };
    ...
    value: "healthy"
  }, "\u2713 Healthy"), /*#__PURE__*/React.createElement("option", {
    value: "warning"
  }, "\u26A0\uFE0F Needs Attention"), /*#__PURE__*/React.createElement("option", {
    value: "critical"
...
const GardenManagerView = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83C\uDF3F My Garden"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowNewGarden(!showNewGarden),
    disabled: gardens.length >= MAX_GARDENS,
    className: `px-4 py-2 rounded-lg transition-colors font-semibold ${gardens.length >= MAX_GARDENS ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-green-600 text-white hover:bg-green-700'}`,
    title: gardens.length >= MAX_GARDENS ? `Maximum ${MAX_GARDENS} boxes reached` : 'Add a new garden box'
  }, "+ New Box (", gardens.length, "/", MAX_GARDENS, ")")), showNewGarden && /*#__PURE__*/React.createElement("div", {
    className: "bg-green-50 p-4 rounded-lg border border-green-200"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-semibold text-gray-800 mb-3"
  }, "Create New Garden Box"), /*#__PURE__*/React.createElement("div", {
    className: "space-y-3"
  }, /*#__PURE__*/React.createElement("input", {
    type: "text",
  ...
  }, ['1x1', '2x2', '2x4', '4x4'].map(type => /*#__PURE__*/React.createElement("button", {
    key: type,
    onClick: () => setNewGardenType(type),
    className: `px-3 py-2 rounded-lg font-semibold transition-colors ${newGardenType === type ? 'bg-green-600 text-white' : 'bg-white border border-green-300 text-gray-700 hover:bg-green-50'}`
    ...
    className: "flex-1 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700"
  }, "Create Garden")))), gardens.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 sm:grid-cols-4 gap-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-4 rounded-lg shadow-sm border-l-4 border-green-500"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-2xl font-bold text-green-600"
  }, gardens.length), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600"
  }, "Garden Boxes")), /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-500"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-2xl font-bold text-blue-600"
  }, totalPlants), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600"
  }, "Plants")), /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-4 rounded-lg shadow-sm border-l-4 border-yellow-500"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-2xl font-bold text-yellow-600"
  }, gardens.reduce((sum, g) => sum + g.squares.filter(s => s.health === 'warning').length, 0)), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600"
  }, "Needs Care")), /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-4 rounded-lg shadow-sm border-l-4 border-red-500"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-2xl font-bold text-red-600"
  }, gardens.reduce((sum, g) => sum + g.squares.filter(s => s.health === 'critical').length, 0)), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600"
  }, "Critical"))), gardens.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "text-center py-16 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-6xl mb-4 block"
  }, "\uD83C\uDF31"), /*#__PURE__*/React.createElement("h3", {
    className: "text-xl font-semibold text-gray-700 mb-2"
  }, "No gardens yet"), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-600 mb-4"
  }, "Start by creating your first garden box!"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowNewGarden(true),
    className: "px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700"
  }, "+ Create First Garden")) : /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 lg:grid-cols-2 gap-6"
  }, gardens.map(garden => /*#__PURE__*/React.createElement("div", {
    key: garden.id
  }, /*#__PURE__*/React.createElement(GardenBox, {
    garden: garden,
    onDelete: handleDeleteGarden,
    onSquareClick: (gardenId, squareIdx) => setSelectedSquare({
      gardenId,
      squareIdx
    })
  })))), selectedSquare && /*#__PURE__*/React.createElement(PlantDetailModal, {
    isOpen: true,
...
const TaskItem = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `p-4 border-l-4 rounded-lg transition-all ${isOverdue ? 'bg-red-50 border-l-red-500' : 'bg-white border-l-green-500'} ${task.completed ? 'opacity-60' : ''}`
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, plantInfo?.emoji), /*#__PURE__*/React.createElement("span", {
    ...
    className: `px-2 py-0.5 text-xs font-semibold rounded ${config.color} ${config.textColor}`
  }, config.icon)), /*#__PURE__*/React.createElement("div", {
    className: "text-sm text-gray-600"
  }, plantInfo?.commonName, " \u2022 ", garden?.name), /*#__PURE__*/React.createElement("div", {
    className: `text-xs mt-1 ${isOverdue ? 'text-red-600 font-semibold' : 'text-gray-500'}`
  }, isOverdue ? `Overdue by ${Math.abs(daysUntilDue)} days` : `Due in ${daysUntilDue} days`)), /*#__PURE__*/React.createElement("button", {
...
const TaskDashboard = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-2xl font-bold text-blue-600"
  }, getFilteredTasks().length), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600"
  }, "Due Soon")), /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-4 rounded-lg shadow-sm border-l-4 border-green-500"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-2xl font-bold text-green-600"
  }, completedThisWeek), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-600"
  ...
  }, ['today', 'week', 'overdue', 'all'].map(type => /*#__PURE__*/React.createElement("button", {
    key: type,
    onClick: () => setFilterType(type),
    className: `px-4 py-2 rounded-lg font-semibold whitespace-nowrap transition-colors ${filterType === type ? 'bg-green-600 text-white' : 'bg-white border border-gray-300 text-gray-700 hover:bg-gray-50'}`
  }, type.charAt(0).toUpperCase() + type.slice(1)))), getFilteredTasks().length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "text-center py-16 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-6xl mb-4 block"
  }, "\u2713"), /*#__PURE__*/React.createElement("h3", {
  ...
  }, "You're all caught up! Great work!")) : /*#__PURE__*/React.createElement("div", {
    className: "space-y-4"
  }, Object.entries(groupedTasks).map(([date, dateTasks]) => /*#__PURE__*/React.createElement("div", {
    key: date
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-600 mb-2 px-4"
  }, date), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2"
  }, dateTasks.map(task => /*#__PURE__*/React.createElement(TaskItem, {
    key: task.id,
    task: task,
    onComplete: taskId => updateTask(taskId, {
...
const SettingsView = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83D\uDDD1\uFE0F Clear All Data"))), /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-lg font-bold text-gray-800 mb-4"
  }, "\u2139\uFE0F About"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-semibold"
  }, "Gardens:"), " ", gardens.length), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    className: "font-semibold"
  }, "Seeds:"), " ", seeds.length), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    className: "font-semibold"
...
const NotificationToast = ({
  ...
  }, /*#__PURE__*/React.createElement("span", null, config.icon), /*#__PURE__*/React.createElement("span", {
    className: "font-semibold"
...
const AppContent = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "max-w-lg mx-auto px-4 pt-24"
  }, activeTab === 'seeds' && /*#__PURE__*/React.createElement(SeedBoxView, null), activeTab === 'garden' && /*#__PURE__*/React.createElement(GardenManagerView, null), activeTab === 'tasks' && /*#__PURE__*/React.createElement(TaskDashboard, null), activeTab === 'settings' && /*#__PURE__*/React.createElement(SettingsView, null)), /*#__PURE__*/React.createElement("div", {
    ...
    className: `flex-1 flex flex-col items-center justify-center gap-1 py-3 transition-colors ${activeTab === tab.id ? 'text-green-600 border-t-2 border-green-600' : 'text-gray-600 hover:text-gray-800'}`
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-2xl"
    ...
    className: "fixed top-20 right-4 z-50 space-y-3 max-w-sm"
  }, notifications.map(notif => /*#__PURE__*/React.createElement(NotificationToast, {
    key: notif.id,
    notification: notif,
...
const App = () => {
  return /*#__PURE__*/React.createElement(DataProvider, null, /*#__PURE__*/React.createElement(AppContent, null));
};
